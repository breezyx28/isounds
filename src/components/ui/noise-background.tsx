...
export interface NoiseBackgroundProps {
  ...
  animating?: boolean;
  /** Animated gradient border only — no noise texture or top accent bar. */
  borderOnly?: boolean;
}

export const ISOUNDS_SHIMMER_GRADIENT = [
  "rgb(183, 134, 234)",
  "rgb(159, 103, 219)",
  "rgb(123, 74, 180)",
] as const;
...
export function NoiseBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-primary/10 p-[3px]",
        !borderOnly && "backdrop-blur-sm shadow-[0px_0.5px_1px_0px_#ddd7ed_inset,0px_1px_0px_0px_#f1eef9]",
        backdropBlur &&
          !borderOnly &&
