...
define(['./workbox-ceb08e7d'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/api\.zoalcast\.com\/api\/.*/i, new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.startsWith("/api/zoalcast/"), new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(({
    url
  }) => /\/(audio|stream)\//i.test(url.pathname), new workbox.NetworkOnly({
